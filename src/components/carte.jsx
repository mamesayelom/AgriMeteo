...
function Carte({selectedRegion, setSelectedRegion}){
  ...
  useEffect(() => {
    ...
    const getFill = (regionId) => {
        return selectedRegion === regionId ? "#e74c3c" : "#16A34A";
    };


    return(
        <div className="w-full flex justify-center ">
            <svg className="w-full h-[300px] md:h-[500px]"  style={{color:"#16A34A"}} baseProfile="tiny" fill="currentColor" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".5" version="1.2" viewBox="0 0 1000 736" xmlns="http://www.w3.org/2000/svg">
            <g id="features">
            ...
            <text
                ...
                x={r.x}
                y={r.y}
                fill={selectedRegion === r.id ? "#e74c3c" : "white"}
                fontSize="12"
                fontWeight="bold"
                textAnchor="middle"
