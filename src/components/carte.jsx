...
function Carte({selectedRegion, setSelectedRegion}){

  const [regions, setRegions] = useState([

    { id: "Dakar", x: 180, y: 280, label: "Dakar" },

    { id: "Thiès", x: 260, y: 260, label: "Thiès" },

    { id: "Diourbel", x: 320, y: 240, label: "Diourbel" },

    { id: "Louga", x: 300, y: 180, label: "Louga" },

    { id: "Saint-Louis", x: 350, y: 120, label: "Saint-Louis" },

    { id: "Matam", x: 600, y: 140, label: "Matam" },

    { id: "Kaffrine", x: 400, y: 300, label: "Kaffrine" },

    { id: "Kaolack", x: 380, y: 340, label: "Kaolack" },

    { id: "Fatick", x: 300, y: 340, label: "Fatick" },

    { id: "Tambacounda", x: 650, y: 350, label: "Tambacounda" },

    { id: "Kédougou", x: 820, y: 520, label: "Kédougou" },

    { id: "Kolda", x: 520, y: 450, label: "Kolda" },

    { id: "Sédhiou", x: 460, y: 500, label: "Sédhiou" },

    { id: "Ziguinchor", x: 380, y: 560, label: "Ziguinchor" }
 
  ]);

  //placer automatiquement les noms des régions au centre de chaque forme SVG
  useEffect(() => {
    const updated = regions.map((r) => {
      //On récupère le SVG correspondant
      const el = document.getElementById(r.id);
      if (!el) return r;

      //ça retourne les dimensions du path ,c’est comme un rectangle invisible autour de la région
      const box = el.getBBox();

      //On crée une nouvelle version des régions(on remplace juste x et y)
      return {
        ...r,
        //ça donne le point central de la région
        x: box.x + box.width / 2,
        ...
        <div className="py-20 w-160 md:h-[600px] ml-7 bg-panel border border-white/10 rounded-2xl">
            ...
            {regions.map((r) => (
              <text
                  ...
                  x={r.x}
                  y={r.y}
                  fill={selectedRegion === r.id ? "#E3B23D" : "#EFE6D3"}
                  fontSize="12"
                  fontWeight="bold"
                  textAnchor="middle"
            ...
            <g id="points">
            <circle className="12.524895537770723|-17.228127589516276" cx="90.9" cy="669.2" id="0">
            </circle>
            <circle className="14.279207053381517|-14.14899530265711" cx="545.5" cy="403" id="1">
            </circle>
            <circle className="16.47209644789501|-11.685689473169777" cx="909.1" cy="67.2" id="2">
            </circle>
            </g>
            <g id="label_points">
            <circle className="Kédougou" cx="813.2" cy="626.1" id="SNKE">
            </circle>
            <circle className="Tambacounda" cx="703.3" cy="455.4" id="SNTC">
            </circle>
            <circle className="Kolda" cx="472.4" cy="595.8" id="SNKD">
            </circle>
            <circle className="Sédhiou" cx="324.7" cy="595.9" id="SNSE">
            </circle>
            <circle className="Ziguinchor" cx="228.7" cy="614.8" id="SNZG">
            </circle>
            <circle className="Saint-Louis" cx="440.3" cy="90.3" id="SNSL">
            </circle>
            <circle className="Matam" cx="602.2" cy="269" id="SNMT">
            </circle>
            <circle className="Kaffrine" cx="390.5" cy="415.1" id="SNKA">
            </circle>
            <circle className="Kaolack" cx="274.8" cy="467.3" id="SNKL">
            </circle>
            <circle className="Fatick" cx="212.2" cy="381.8" id="SNFK">
            </circle>
            <circle className="Louga" cx="354.5" cy="231.2" id="SNLG">
            </circle>
            <circle className="Thiès" cx="141.4" cy="333.2" id="SNTH">
            </circle>
            <circle className="Dakar" cx="88.4" cy="325.8" id="SNDK">
            </circle>
            <circle className="Diourbel" cx="269.2" cy="329" id="SNDB">
            </circle>
            </g>
            </svg>
        </div>
